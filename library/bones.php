...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_style( 'wayward-stylesheet', get_template_directory_uri() . '/library/css/style.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'wayward-stylesheet' );
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu_class' => 'nav navbar-nav navbar',  			// adding custom nav class
...
return '...</p><p>';
	...
	// Read More Button to Content
	
	// return '...</p><p><a class="excerpt-read-more btn btn-primary" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . 
	// get_the_title($post->ID).'">'. __( 'Read More', 'bonestheme' ) .'</a>';
}
