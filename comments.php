...
<div id="respond" class="respond-form">
  ...
  <h3 id="comment-form-title"><?php comment_form_title( __( 'Join in the conversation!', 'bonestheme' ), __( 'Leave a Reply to %s', 'bonestheme' )); ?></h3>
  ...
  <p><textarea name="comment" id="comment" placeholder="<?php _e( 'Enter your comments here', 'bonestheme' ); ?>" tabindex="4"></textarea></p>
