			...
			<div class="single-post-title">
				...
				<div class="clearfix row">
					<div class="col-sm-12 text-center">
						...
						<h6 class="author clearfix">
								<em> <?php echo bones_get_the_author_posts_link() ?> | 
								<time class="updated" datetime="<?php get_the_time('Y-m-j') ?>">
									<?php echo get_the_time(get_option('date_format')) ?></time></em>
...
<!--End Hero-->
 ...
 <div class="container content-wrapper single-page-wrapper"> 

	<!-- Begin .entry-content -->

	<div id="heading" class="clearfix row">
				...
				<div id="main" class="col-md-10 clearfix" role="main">
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
							...
							<footer class="article-footer single-footer clearfix">
								<span class="tags pull-left"><?php printf( '<span class="">' . __( 'Topics: %1$s&nbsp;&nbsp;', 'bonestheme' ) . '</span>', get_the_category_list(', ') ); ?> <?php the_tags( '<span class="tags-title">' . __( '<i class="fa fa-tags"></i>', 'bonestheme' ) . '</span> ', ', ', '' ); ?></span>
